    ...
    <div className="border-2 border-[#F6B501] rounded-xl ">
      <div className="p-5">
        ...
        <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-2 gap-4 mt-3">
          <button className="bg-[#E6EBE3] p-1 rounded mt-2 w-28 font-semibold">
            Building
          </button>
          <button className="bg-[#E6EBE3] p-1 rounded mt-2 w-28 font-semibold">
            Building
        ...
        <div className="mt-3">
          <h1 className="text-center text-[#F6B501] font-semibold">
            -- {data.view}
          </h1>
        </div>
      </div>
      <button
        ...
        className="w-full font-semitbold bg-[#F6B501] p-3 rounded"
      >
        view
      </button>
    </div>
